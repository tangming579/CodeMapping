...
public class PoiUtils {
	 public static ResponseEntity<byte[]> exportEmp2Excel(List<AssetItem> items){
	 ...
	 public static List<AssetItem> importEmp2List(MultipartFile file){
		 List<AssetItem> emps=new ArrayList<>();
		 try {
